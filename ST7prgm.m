...
pcaorig=sum(P,1)/length(P); %bestemmer punkt p� plan som er vinkelret til origo
...
figure()
for j=1:length(inf_p_leads) %ser kun p� 180 grader. Genneml�ber 180 graders leads
    lead=inf_p_leads(j,:)'; 
